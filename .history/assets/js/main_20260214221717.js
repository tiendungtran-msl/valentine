...
const LOVE_BRIDGES = [
  ...
  'Anh thích cái cách em làm một ngày dài trở nên dễ thở hơn.',
  'Nhiều khi anh không cần gì cả — chỉ cần được nghe em nói một câu thôi.',
  'Có những điều anh không giỏi nói thành lời, nên anh chọn ở cạnh em lâu hơn.',
  ...
  'Nếu được chọn lại, anh vẫn chọn đi về phía em, thêm một lần nữa.',
  ...
  'Thương em là nhớ: nhớ ăn, nhớ ngủ, nhớ giữ ấm, nhớ nói chuyện đàng hoàng.',
  'Valentine này anh không cần rực rỡ — anh chỉ muốn em thấy mình được yêu.',
  'Anh muốn dành phần yêu nhiều nhất của anh cho em, bằng những việc rất thường ngày.',
];
